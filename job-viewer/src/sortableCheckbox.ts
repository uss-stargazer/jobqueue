// Credit: https://github.com/th0r/inquirer-sortable-checkbox/
// Is inquirer-sortable-checkbox but it has a better return type for sorting and uses shift instead of ctrl for sorting
...
export default createPrompt(
  <Value>(
    config: Config<Value>,
    done: (value: Array<{ value: Value; checked: boolean }>) => void,
  ) => {
    const {
      instructions,
      pageSize = 7,
